...
// import { NounsUtilsABI } from '@nouns/sdk';
...
export enum NounsUtilsContractFunction {
  settleCurrentCreateNewAuctionAndBid = 'settleCurrentCreateNewAuctionAndBid',
}
...
// const abi = new utils.Interface(NounsUtilsABI);
