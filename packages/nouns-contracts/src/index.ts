...
export { default as NounsUtilsABI } from '../abi/contracts/NounsUtils.sol/NounsUtils.json';
...
export { NounsUtils__factory as NounsUtilsFactory } from '../typechain/factories/contracts/NounsUtils.sol/NounsUtils__factory';
